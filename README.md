...
![Channel Your Inner White Boy...](inspirations/G71QDQQa8AAELxy.jpg)
## How to use the bot
...
2. `/whiteboy timezone <timezone>` - This will setup the timezone that lets the bot figure out when it should send these images, They are typically sent at around 6am every single day. You can find a list of all available timezones [here](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones#List)
...
## be well... white boy
![I am always lurking... white boy](inspirations/G7jEY6ea8AAx0Cm.png)